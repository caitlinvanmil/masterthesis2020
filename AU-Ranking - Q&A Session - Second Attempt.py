...
# Keeping only the rows that correspond with the Q&A session and with a confidence higher than or equal to .7

# In[28]:


p1c = p1[(p1[" confidence"] >= 0.7) & (p1[" timestamp"] > 208.00)]


# In[29]:


p2c = p2[(p2[" confidence"] >= 0.7) & (p2[" timestamp"] > 195.00)]


# In[30]:


p3c = p3[(p3[" confidence"] >= 0.7) & (p3[" timestamp"] > 335.00)]


# In[31]:


p4c = p4[(p4[" confidence"] >= 0.7) & (p4[" timestamp"] > 206.00)]


# In[32]:


p5c = p5[(p5[" confidence"] >= 0.7) & (p5[" timestamp"] > 194.00)]


# In[33]:


p6c = p6[(p6[" confidence"] >= 0.7) & (p6[" timestamp"] > 204.00)]


# In[34]:


p7c = p7[(p7[" confidence"] >= 0.7) & (p7[" timestamp"] > 329.00)]
...
p24c = p24[(p24[" confidence"] >= 0.7) & (p24[" timestamp"] > 203.00)]
