...
p1c2 = p1c[(p1c[" confidence"] >= 0.7) & (p1c[" timestamp"] >= 51.00) & (p1c[" timestamp"] <= 208.00)]


# In[54]:


p2c2 = p2c[(p2c[" confidence"] >= 0.7) & (p2c[" timestamp"] >= 5.00) & (p2c[" timestamp"] <= 195.00)]


# In[55]:


p3c2 = p3c[(p3c[" confidence"] >= 0.7) & (p3c[" timestamp"] >= 19.00) & (p3c[" timestamp"] <= 335.00)]


# In[56]:


p4c2 = p4c[(p4c[" confidence"] >= 0.7) & (p4c[" timestamp"] >= 1.00) & (p4c[" timestamp"] <= 206.00)]


# In[57]:


p5c2 = p5c[(p5c[" confidence"] >= 0.7) & (p5c[" timestamp"] >= 3.00) & (p5c[" timestamp"] <= 194.00)]


# In[58]:


p6c2 = p6c[(p6c[" confidence"] >= 0.7) & (p6c[" timestamp"] >= 5.00) & (p6c[" timestamp"] <= 204.00)]


# In[59]:


p7c2 = p7c[(p7c[" confidence"] >= 0.7) & (p7c[" timestamp"] >= 23.00) & (p7c[" timestamp"] <= 329.00)]
...
p24c2 = p24c[(p24c[" confidence"] >= 0.7) & (p24c[" timestamp"] >= 1.00) & (p24c[" timestamp"] <= 203.00)]
...
X_padded_2d = X_padded.reshape(25, 17*14151)
X_padded_2d.shape
...
for i in range(0,17):
    for j in range(0,17):
        sum_AU_r = sum(loading_matrix.iloc[i*14151:i*14151+14151:, j:j+1].values)
